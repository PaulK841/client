...
// --- Icônes (avec un DiscordIcon beaucoup plus simple) ---
...
// --- NOUVELLE ICÔNE DISCORD SIMPLIFIÉE ---
const DiscordIcon = () => (
  ...
  return (
    <div className="payment-status-page">
      <div className="success-card">
        ...
        <p>Thank you for your purchase. Your access to AimGuard has been activated. Here are your next steps:</p>
