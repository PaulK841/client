...
// --- Icônes que nous allons maintenant utiliser ici ---
...
const ProfilePage = () => {
  ...
  // On s'assure que les données sont à jour à chaque fois que la page est affichée.
  useEffect(() => {
    if (user) {
      refreshUserProfile();
    }
        ...
        {isSubscribed ? (
          ...
          <div className="member-area">
            ...
            <div className="member-actions">
              <div className="member-action-card">
                ...
                <a href="#" className="auth-button">Download Now</a> 
              </div>
              <div className="member-action-card">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" className="secondary-button">Join Discord</a>
              </div>
            </div>
          </div>
        ) : (
          ...
          <>
            {user.subscriptionExpiresAt ? (
              // Option si l'abonnement a expiré
              ...
              // Option pour un tout nouvel utilisateur
              <div className="profile-actions">
                <h2>Get AimGuard</h2>
